...
struct OneBand : Module {
	...
	void process(const ProcessArgs &args) override {
		...
		*/
		...
		//outputs[devParamOutGain].value = params[EQGAIN_PARAM].getValue();
		//outputs[devParamOutFrq].value = params[EQFREQ_PARAM].getValue();
		//outputs[devParamOutQ].value = params[EQBANDWIDTH_PARAM].getValue();
		//dev---Check parameter value---------------------------------
...
struct OneBandWidget : ModuleWidget {
	...
	OneBandWidget(OneBand *module) {
		...
		//addOutput(createOutput<BarkPatchPortIn>(Vec(34.16f, rackY - 324.73f), module, OneBand::devParamOutGain));
		//addOutput(createOutput<BarkPatchPortIn>(Vec(2.16f, rackY - 307.59f), module, OneBand::devParamOutFrq));
		//addOutput(createOutput<BarkPatchPortIn>(Vec(33.78f, rackY - 248.26f), module, OneBand::devParamOutQ));
		//Knobs---
