...
out. Created get around an issue with level/pan inputs on Poly Mix as you need to send a 1v signal to level if there is a level mod on a
previous channel. For pan use 0v for level unmute the signal.
